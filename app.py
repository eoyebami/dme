...
driver.execute_script("arguments[0].click();", elem)
time.sleep(random.randint(1, 5))
elem = driver.find_element(By.XPATH, "//input[contains(@placeholder,'Email or username')]")
elem.send_keys(username)
time.sleep(random.randint(1, 5))
elem = driver.find_element(By.XPATH, "//input[contains(@placeholder,'Password')]")
elem.send_keys(password)
time.sleep(random.randint(1, 5))
elem = driver.find_element(By.XPATH, "//*[contains(text(), 'Log in') and @data-e2e='login-button']")
driver.execute_script("arguments[0].click();", elem)
time.sleep(random.randint(1, 5))
